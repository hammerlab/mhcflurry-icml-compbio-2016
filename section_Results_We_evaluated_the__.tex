...
We then compared the performance of MHCflurr against NetMHC, NetMHCpan, and SMM on the blind test data. The MHCflurry ensemble model contains 10 predictors initialized with different random weights. MHCflurry is competitive with both NetMHC and NetMHCpan.
